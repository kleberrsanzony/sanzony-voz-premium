...
import { ShieldCheck, ShieldX, Search, Loader2, Mic2, Hash, FileCheck2 } from "lucide-react";
        ...
        <div className="container-site w-full max-w-xl px-6">
          ...
          {loading && !searched && (
            <div className="flex flex-col items-center py-10 gap-3">
              ...
              <p className="text-xs text-muted-foreground">{t.briefing.form.submitting}</p>
            </div>
          )}
        </div>
      </div>
