        ...
        <div className="container-site w-full max-w-xl">
          ...
          <div className="mb-10 text-center">
            ...
            <p className="text-sm text-muted-foreground leading-relaxed">
              Insira o número do certificado (ex:{" "}
              <span className="font-mono text-[#e0c27a]/70 text-xs">SVZ-2026-ABR-001</span>
          ...
          {!searched && (
            <div className="flex items-center gap-3 border border-white/[0.06] rounded-md p-4 bg-white/[0.02]">
              ...
              <p className="text-xs text-muted-foreground leading-relaxed">
                O sistema de certificação Sanzony.Voz utiliza hash SHA-256 para garantir
                a originalidade e integridade de cada arquivo de áudio entregue.
              </p>
            </div>
          )}
        </div>
